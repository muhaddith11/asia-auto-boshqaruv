          ...
          <div className="bg-[#1e212b] border border-blue-500/20 rounded-2xl p-6 grid grid-cols-2 gap-8">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 py-3 rounded-xl border-2 transition-all font-black text-[12px] uppercase tracking-widest ${method === 'naqd' ? 'bg-emerald-500/10 border-emerald-500 text-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.2)]' : 'border-border bg-black/20 text-slate-500 hover:border-slate-700'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 py-3 rounded-xl border-2 transition-all font-black text-[12px] uppercase tracking-widest ${method === 'karta' ? 'bg-blue-500/10 border-blue-500 text-blue-500 shadow-[0_0_15px_rgba(59,130,246,0.2)]' : 'border-border bg-black/20 text-slate-500 hover:border-slate-700'
                      }`}
                  >
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    />
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] text-blue-500 font-black uppercase">UZS</div>
                  </div>
                </div>
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full bg-black/20 border-border border-2 rounded-xl p-3 text-[12px] text-white outline-none focus:border-blue-500 transition-all h-[208px] resize-none"
              />
            </div>
          </div>
        </div>
